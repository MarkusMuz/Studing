    ...
    <body>
        ...
        <div>
            <form method="post" action="./lab4">
                <p>Визначити перші n слів, що зустрічаються найчастіше</p>
                <input type="text" name="task4" placeholder="Цифра"/>
                <p>Визначити кількість слів що не містять певну літеру</p>
                <input type="text" name="task5" placeholder="Літера"/>
                <p>Визначити кількість слів, що мають рівно n однакових літер</p>
                <input type="text" name="task6" placeholder="Цифра"/>
                <p>Визначити перші n трьохлітерні послідовності у словах тексту, що зустрічаються найчастіше</p>
